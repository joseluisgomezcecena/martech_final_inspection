					...
					<div class="col-lg-12">
						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-6 col-sm-12">
								...
								<input type="number" class="form-control" name="qty" value="<?= $old["qty"] ?>" required oninvalid="this.setCustomValidity('Coloque la cantidad enviada')" oninput="this.setCustomValidity('')" style="text-transform: uppercase;">
							</div>
